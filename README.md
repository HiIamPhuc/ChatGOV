...
```
AI_Wrapper-WebPage/
├── 1_frontend/          # React TypeScript frontend
│   ├── public/          # Static assets (images, logos)
│   ├── src/
│   │   ├── components/  # Reusable UI components
│   │   ├── pages/       # Page components
│   │   ├── services/    # API service functions
│   │   ├── app/         # App-level utilities (i18n, theme, toast)
│   │   └── hooks/       # Custom React hooks
│   └── ...config files
├── 2_backend/           # Python FastAPI backend
│   ├── routers/         # API route handlers
│   ├── utils/           # Utility functions
│   ├── models.py        # Pydantic data models
│   ├── database.py      # Database operations
│   ├── graph.py         # LangGraph workflow
│   ├── tools.py         # AI tools for service search
│   └── prompts.py       # AI system prompts
├── 3_crawler/           # Data crawler (future implementation)
└── README.md
```
...
2. **Vector Search**: Service matching using semantic embeddings
